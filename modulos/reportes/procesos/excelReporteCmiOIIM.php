...
$sheet->getStyle("A5:AZ5")->applyFromArray(array("font" => array( "bold" => true)));
$sheet->getStyle("A1:B2")->applyFromArray(array("font" => array( "bold" => true)));
 
$sheet->getStyle("A4:AZ5")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER)->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
$sheet->getStyle("D6:AZ174")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER)->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
$sheet->getStyle("A6:AZ174")->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
...
$sheet->getStyle('A4:AX5')->applyFromArray($styleThinBlackBorderOutline);/*border de encabezad*/
                ...
                elseif ($objConsultaReportes->open_con()) 
                                {
                                    ...
                                    $ReporteExcel=$objConsultaReportes->ReporteCmiperspectivasMetas($idP,$idplan);
                                    $encabezado=$objConsultaReportes->EncabezadoExcel();
                                    $sheet->setCellValueByColumnAndRow(0,3,'PERSPECTIVA: '.$nombrePerspectiva); 
                                    /**************************************/
