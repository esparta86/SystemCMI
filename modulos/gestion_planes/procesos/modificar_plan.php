...
$objplanestrategico=new planestrategico();
    if($objplanestrategico!=null){//si se creo el objeto
			    ...
			    elseif ($objplanestrategico->open_con()) 
							    {            
							     $estado=$objplanestrategico->modificar_plan($idE,$visionE,$misionE,$valoresE,$fechaI,$fechaF,$idplan);
											         
								       switch ($estado) {
								       	case 1:
								       		$data1[] = array('bandera'=>1,'msg'=>'Exito, Se modifico el plan estrategico.');  
								       		break;
								       	case 2:
