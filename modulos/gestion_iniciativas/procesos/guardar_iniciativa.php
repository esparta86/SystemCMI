...
$objiniciativaEstrategica=new iniciativaEstrategica();
    if($objiniciativaEstrategica!=null){
			    ...
			    elseif ($objiniciativaEstrategica->open_con()) 
							    {            
							    $estado=$objiniciativaEstrategica->guardar_iniciativaE($indicadorid,$areaid,$unidadid,$corr,$iniciativaText);
								       switch ($estado) {
								       	case 1:
								       		  $objunidadesInvolucradas=new unidadesInvolucradas();
	     						       		  $estado2=$objunidadesInvolucradas->guardarUnidadesInvolucradas($involucradasid,$indicadorid,$unidadid,$iniciativaText);
	     						       		      switch ($estado2) 
	     						       		      {
	     						       		      	case 1:
	     						       						$data1[] = array('bandera'=>1,'msg'=>'Exito,Se agrego iniciativa Estrategica.');
	     						       					break;
	     						       		      	case 2:
