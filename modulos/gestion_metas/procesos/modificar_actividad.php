...
$objMetaOperativa=new MetaOperativa();
    if($objMetaOperativa!=null){
			    ...
			    elseif ($objMetaOperativa->open_con()) 
							    {            
							    $estado=$objMetaOperativa->modificar_actividad($Activid,$Result,$MedioV,$RecursoF,$idcargo,$observacionA,$fechaI,$fechaF,$idiniciativa,$actividad);
								       switch ($estado) {
								       	case 1:
								       		 $data1[] = array('bandera'=>1,'msg'=>'Exito,Se modifico la meta operativa ');
